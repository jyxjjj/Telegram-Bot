...
class KernelFeodra implements SoftwareInterface
{
    ...
    public function generateMessage(int $chat_id, string $version): array
    {
        ...
        $button1 = new InlineKeyboardButton([
            ...
            'url' => 'https://mirrors.ustc.edu.cn/fedora/updates/42/Everything/x86_64/Packages/k/',
        ]);
        $button2 = new InlineKeyboardButton([
            'text' => 'Europe Edge Mirror',
            'url' => 'https://eu.edge.kernel.org/fedora/updates/42/Everything/x86_64/Packages/k/',
        ]);
